...
public abstract class AbstractHornetqCommand extends AbstractCommand {
	...
	protected TransportConfiguration getTransportConfiguration(PlungerArguments jca) {
		Map<String, Object> connectionMap = new HashMap<>();
		connectionMap.put(TransportConstants.HOST_PROP_NAME, jca.getTarget().getHost());
		connectionMap.put(TransportConstants.PORT_PROP_NAME, jca.getTarget().getPort());
